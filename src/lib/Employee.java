...
=======
	...
	public Employee(String employeeId, String firstName, String lastName, String idNumber, String address, LocalDate dateJoined, boolean isForeigner, boolean isMale) {
		...
		'Sebenrnya fungsi ini untuk menentukan apakah seperti nilai string ini null atau tidak 
		jika null maka akan termasuk IllegalArgumentException'

		'Menurut saya, makanya saya perbaiki'
